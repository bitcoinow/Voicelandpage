...
`;function c(i){const e=document.getElementById(i);e&&e.scrollIntoView({behavior:"smooth"})}window.scrollToSection=c;function r(){const i=document.getElementById("contactForm");i&&i.addEventListener("submit",function(e){e.preventDefault();const n=new FormData(i),t=Object.fromEntries(n),a=i.querySelector('button[type="submit"]'),s=a.innerHTML;a.innerHTML='<i class="fas fa-check"></i> Message Sent!',a.style.background="#10b981",setTimeout(()=>{i.reset(),a.innerHTML=s,a.style.background=""},2e3),console.log("Contact form submitted:",t)})}document.addEventListener("DOMContentLoaded",function(){r();const i=document.querySelector(".mobile-menu-toggle"),e=document.querySelector(".nav-links");i&&e&&i.addEventListener("click",function(){e.classList.toggle("active")}),document.querySelectorAll('.nav-links a[href^="#"]').forEach(a=>{a.addEventListener("click",function(s){s.preventDefault();const o=this.getAttribute("href").substring(1);c(o),e.classList.contains("active")&&e.classList.remove("active")})});const t=document.querySelectorAll('a[href^="https://startling-daffodil-714b24.netlify.app/"]');console.log(`Found ${t.length} external links to VoiceNote Mentor app`),t.forEach(a=>{a.addEventListener("click",function(){console.log("External link clicked:",this.href)})})});window.addEventListener("scroll",function(){const i=document.querySelector(".navbar");window.scrollY>50?i.classList.add("scrolled"):i.classList.remove("scrolled")});
